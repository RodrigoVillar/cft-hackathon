...
const AVALANCHE_SUBNET_PARAMS = {
  chainId: '0xA869',
  chainName: 'Avalanche Subnet Game 1',
  nativeCurrency: {
    name: 'Avalanche',
    symbol: 'AVAX',
    decimals: 18
  },
  rpcUrls: ['http://127.0.0.1:9650/ext/bc/2m1gzw5eRaJYqNtmwvA6nJwXaXyKKwFHnNWdmVhbohrC44yRnN/rpc'],
  blockExplorerUrls: ['']
}
...
const AVALANCHE_NETWORK_PARAMS = AVALANCHE_SUBNET_PARAMS
  ...
  switchToAvalancheChain() {
    ...
    window.ethereum
      .request({
        ...
        params: [AVALANCHE_SUBNET_PARAMS]
      })
  }
